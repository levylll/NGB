...
class ZmxtView(BaseMixin,ListView):
    template_name = 'blog/zmxt.html'
    context_object_name = 'comment_list'
    def get_context_data(self,**kwargs):
        #轮播
        kwargs['comment_list'] = ZmxtCls.objects.all()
        return super(ZmxtView,self).get_context_data(**kwargs)

    def get_queryset(self):
        comment_list = ZmxtCls.objects.all()
        return comment_list
    ...
    def post(self, request, *args, **kwargs):
        ...
        #保存评论
        comment = ZmxtCls.objects.create(
                comment = valbuf
                )
